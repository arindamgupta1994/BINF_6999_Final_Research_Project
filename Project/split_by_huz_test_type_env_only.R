...
dir.create("H_Heatmaps", showWarnings = FALSE)
...
combined_heatmap <- wrap_plots(heatmap_list, ncol = 4) +
  plot_annotation(title = "NMF H Matrices Across Subsets")

# Save combined heatmap
ggsave("H_Heatmaps/Combined_H_Heatmaps.png",
       combined_heatmap,
...
dir.create("LM_Plots", showWarnings = FALSE)
...
# Save to file
ggsave("LM_Plots/Combined_Pred_vs_Actual_with_labels.png",
       plot = final_plot,
       width = 15, height = 10, dpi = 300)

####################### 6. LM WITHOUT NMF ##########################

dir.create("LM_Plots_NoNMF", showWarnings = FALSE)
...
# Save to file
ggsave("LM_Plots_NoNMF/Combined_Pred_vs_Actual_NoNMF_with_labels.png",
       plot = final_plot,
       width = 15, height = 10, dpi = 300)
